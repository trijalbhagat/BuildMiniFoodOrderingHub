export type Category = "All" | "Pizza" | "Burgers" | "Drinks" | "Desserts" | "Healthy";
...
export interface MenuItem {
  ...
  veg: boolean;
  urgency: UrgencyType;
  stockLeft?: number;    // used when urgency = "low-stock"
  ordersRecent?: number; // used when urgency = "popular-now"
}

export const CATEGORIES: Category[] = [
  "All", "Pizza", "Burgers", "Drinks", "Desserts", "Healthy",
];
...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    category: "Burgers",
    price: 12.99,
    description: "Double smashed beef patty, American cheese, dill pickles, secret sauce.",
  ...
  {
    id: 6,
    name: "Wagyu Double Stack",
    category: "Burgers",
    price: 24.99,
    description: "Australian wagyu beef, aged cheddar, caramelized onion jam, truffle aioli.",
    rating: 4.9, reviews: 312, badge: "chef", popular: true, veg: false,
