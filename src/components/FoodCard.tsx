...
// ── Item badge (Chef's Pick / Popular / New) ──────────────────────────────────
...
// ── Compact row (inside CategoryPanel) ───────────────────────────────────────
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden h-48 bg-orange-100 dark:bg-orange-950/30 shrink-0">
        ...
        {/* Hover-triggered particle effect */}
      ...
      <div className="p-4 flex flex-col flex-1 gap-2">
        ...
        <div className="flex justify-between items-start gap-2">
          <div className="flex items-center gap-1.5 min-w-0">
            <VegDot veg={item.veg} />
            <h3 className="font-bold text-[15px] leading-snug text-foreground truncate">
              {item.name}
            </h3>
          </div>
        ...
        {/* Urgency badge — only shown when present */}
        <UrgencyBadge
          urgency={item.urgency}
          stockLeft={item.stockLeft}
          ordersRecent={item.ordersRecent}
        />
