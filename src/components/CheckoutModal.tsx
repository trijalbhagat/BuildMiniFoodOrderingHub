    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          onClick={(e) => {
            if (!placed && e.target === e.currentTarget) onClose();
          }}
        >
          <motion.div
            ...
            {placed ? (
              ...
              >
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Your food is being prepared with love. Estimated delivery:{" "}
                  <strong className="text-foreground">25–35 min</strong>.
                </p>
              </motion.div>
            ) : (
              <>
                ...
                <div className="px-6 py-5 space-y-6 max-h-[65vh] overflow-y-auto">
                  {/* Order summary — rendered via map() */}
                  <div>
                  ...
                  {/* Payment method — rendered via map() */}
                  <div>
                    <label className="flex items-center gap-1.5 text-sm font-bold text-foreground mb-2">
