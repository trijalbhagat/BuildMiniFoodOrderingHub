...
export default function ComboCard({ combo, onAddCombo }: ComboCardProps) {
  ...
  const handleAddCombo = () => {
    // Cast combo items to MenuItem shape for the cart hook
  ...
  return (
    ...
    >
      {/* ── Gradient banner with stacked food images ── */}
      <div className={`relative bg-gradient-to-r ${combo.gradient} p-5 pb-0`}>
        {/* Best value / custom badge */}
        {combo.badge && (
        ...
        <div className="flex items-end gap-0">
          ...
          {/* Filler space so images feel grounded */}
