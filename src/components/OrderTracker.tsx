...
const STAGE_DURATIONS = [4000, 8000, 10000]; // ms to advance to next stage

export default function OrderTracker({ visible, onDismiss, orderTotal }: OrderTrackerProps) {
  const [stage, setStage]       = useState(0);
  const [collapsed, setCollapsed] = useState(false);
  const [eta, setEta]           = useState(32); // minutes

  // Auto-advance through delivery stages
  useEffect(() => {
                ...
                >
                  <div className="px-4 py-4 space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <motion.div
                        className="absolute left-[13px] top-3 w-0.5 bg-orange-500 origin-top"
